...
@Schema(name = "CouponCreateRequest: 쿠폰 생성 요청")
public class CouponCreateRequest {
    ...
    public CouponCreateRequest(
            String name, CouponType couponType, float discountRate,
            Integer discountPrice, Integer remainQuantity, LocalDateTime expireDateTime){
        this.name = name;

...
public class UserApiControllerTest {
    ...
    @Test
    void test() {
        ResponseEntity<UserResponse> byId = userApiController.findById(1L);
    ...
    @Test
    void test2(){
        ResponseEntity<UserPointResponse> userPointById = userApiController.findUserPointById(1L);
    ...
    @Test
    void test3(){
        ResponseEntity<UserCouponResponse> userCouponListByUserId = userApiController.findUserCouponListByUserId(1L);
    ...
    @Test
    void test4(){
        ResponseEntity<UserPointResponse> userPointResponseResponseEntity = userApiController.chargePoint(1L, 2000);
